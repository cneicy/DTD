...
var air as IItemStack = <item:minecraft:air>;
...
craftingTable.addShapeless("enigmaticitem",<item:enigmaticlegacy:enigmatic_item>,
    [<item:enigmaticlegacy:unholy_grail>,<item:enigmaticlegacy:astral_dust>,<item:enigmaticlegacy:oblivion_stone>,
    <item:enigmaticlegacy:golem_heart>,<item:enigmaticlegacy:angel_blessing>,<item:enigmaticlegacy:ocean_stone>,
    <item:enigmaticlegacy:magma_heart>,<item:enigmaticlegacy:eye_of_nebula>,<item:enigmaticlegacy:void_pearl>]);
craftingTable.addShapeless("lootgamestime",<item:lootgames:puzzle_master>,
    [<item:paraglider:spirit_orb>,<item:paraglider:spirit_orb>,<item:paraglider:spirit_orb>,
    <item:paraglider:spirit_orb>,<item:paraglider:spirit_orb>,<item:paraglider:spirit_orb>,
    <item:paraglider:spirit_orb>,<item:paraglider:spirit_orb>,<item:paraglider:spirit_orb>]);
...
var names as string[] = [
    "onerelics","tworelics",
    "threerelics","fourrelics",
    "adzuki_cake_sliceph","aspen_pantryph",
    "banana_cake_sliceph","cherry_cookieph",
    "cherry_cream_sodaph","cherry_pantryph",
    "chocolate_cake_sliceph","cooked_duck_filletph",
    "cooked_perch_sliceph","cooked_pike_sliceph",
    "cooked_venison_shanksph","driftwood_pantryph",
    "duck_filletph","duck_noodlesph",
    "dune_platterph","escargotph",
    "grimwood_pantryph","kousa_pantryph",
    "maple_cookieph","maple_glazed_baconph",
    "maple_pantryph","mint_cake_sliceph",
    "morado_pantryph","mulberry_cookieph",
    "necromium_knifeph","passion_aloe_nectarph",
    "passionfruit_glazed_duckph","perch_sliceph",
    "perch_with_mushroomsph","pickerelweed_juiceph",
    "pike_sliceph","pike_with_beetrootph",
    "poise_pantryph","river_pantryph",
    "rosewood_pantryph","seared_venisonph",
    "silver_knifeph","slabdishph",
    "strawberry_cake_sliceph"
];

for i in 0 .. relics.length {
craftingTable.addShapedMirrored(names[i],relics[i], [
    [air,<item:paraglider:spirit_orb>,air], 
