...
var fish = LootConditionBuilder.create() 
    .add<LootTableId>(condition => {
...
loot.modifiers.register("fisher", fish, CommonLootModifiers.add(<item:abyssaldepths:butterflyfish> * 3));
...
var enchantbook as IItemStack[] = [
    <item:minecraft:enchanted_book>.withTag({StoredEnchantments: [{lvl: 2 as short, id: "minecraft:protection" as string}]}),<item:minecraft:enchanted_book>.withTag({StoredEnchantments: [{lvl: 1 as short, id: "ma-enchants:faster_attack" as string}]})
];
var enchantbooknumber as string[] = [
    "enchantone","enchanttwo"
];
for i in 0 .. enchantbook.length {
loot.modifiers.register(enchantbooknumber[i], enchantbooks, CommonLootModifiers.add(enchantbook[i]));
}
...
<item:farmersdelight:beef_patty>,<item:neapolitan:neapolitan_ice_cream>,<item:neapolitan:adzuki_milkshake>,<item:neapolitan:vanilla_pudding>,<item:neapolitan:dried_vanilla_pods>,<item:neapolitan:chocolate_milkshake>,<item:vanillacookbook:carrot_soup>,<item:vanillacookbook:apple_pie>,<item:vanillacookbook:meatball>,<item:vanillacookbook:ice_cream_cake_slice>,<item:vanillacookbook:melon_soda>
];
var snacknumber as string[] = [
    "yummy","tasted","delicious","pudding","vanilla","milkshake","soup","applepie","meatball","cakeslice","soda"
];
...
var arcane_ore = LootConditionBuilder.create() 
    .add<LootTableId>(condition => {
        condition.withTableId(<resource:stoneholm:miner>);
    })
    .add<RandomChance>(condition => {
        condition.withChance(0.45);
    });
loot.modifiers.register("arcane_ore", arcane_ore, CommonLootModifiers.add(<item:ars_nouveau:arcane_ore> * 3));
