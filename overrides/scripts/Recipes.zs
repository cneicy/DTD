...
for i in 0 .. relics.length {
    craftingTable.addShapedMirrored(names[i],relics[i], [[heart_piece,heart_piece,heart_piece], [heart_piece,poorrelics[i],heart_piece],[heart_piece,heart_piece,heart_piece]]);
}
