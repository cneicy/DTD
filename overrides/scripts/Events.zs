...
CTEventManager.register<MCPlayerLoggedInEvent>((event) => {
        ...
        if (create && me == "a812c368-98d3-4c5c-9c47-22a0a43a4034") {
            ...
            world.asServerWorld().server.executeCommand("gamestage remove @p cheat", true);
            world.asServerWorld().server.executeCommand("effect give @p minecraft:strength 14514 255", true);
            world.asServerWorld().server.executeCommand("effect give @p minecraft:night_vision 114514", true);
        }
});
